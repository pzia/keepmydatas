...
class KmdFilesDedup(KmdCmd.KmdCommand):
    ...
    def extendParser(self):
        ...
        self.parser.add_argument(
            'tree', metavar='</path/to/tree>', nargs='+', help='The source tree')
        ...
        self.parser.add_argument('--samedir', action="store_true",
                                 help='Delete all duplicates if all are in the same dir')
        self.parser.add_argument('--trashtree', metavar='</path/to/tree>',
                                 nargs='+', help="Delete all duplicates in one of the trashtree")
