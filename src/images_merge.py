...
class KmdImagesMerge(KmdCmd.KmdCommand):
    def extendParser(self):
        ...
        self.parser.add_argument(
            'folders', metavar='</path/to/folder>', nargs='+', help='A list of folders')
        self.parser.add_argument('--quick', action="store_true",
                                 help='Compare only if size differs for more than 1000 bytes')
